        ...
        >
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center space-x-2 py-3 border border-wolf-200 dark:border-wolf-700 rounded-lg hover:bg-wolf-50 dark:hover:bg-wolf-800 transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center justify-center space-x-2 py-3 border border-wolf-200 dark:border-wolf-700 rounded-lg hover:bg-wolf-50 dark:hover:bg-wolf-800 transition-colors"
              >
                <Mail className="w-5 h-5 text-wolf-500" />
                <span className="text-wolf-700 dark:text-wolf-300 font-medium">Email</span>
              </button>
            </div>
          </div>
