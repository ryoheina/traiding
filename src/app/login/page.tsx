    ...
    <div className="min-h-screen bg-gradient-to-br from-wolf-50 via-white to-wolf-100 dark:from-wolf-950 dark:via-wolf-900 dark:to-wolf-950 py-12 px-4 sm:px-6 lg:px-8 flex items-center">
      <div className="max-w-md mx-auto w-full">
        <motion.div
          ...
          className="bg-white dark:bg-wolf-900 rounded-2xl shadow-2xl p-8 border border-wolf-200 dark:border-wolf-800"
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 text-gold-500 border-wolf-300 rounded focus:ring-gold-500"
                />
                <span className="ml-2 text-sm text-wolf-600 dark:text-wolf-400">Remember me</span>
              </label>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6">
              <button
                type="button"
                className="w-full flex items-center justify-center space-x-2 py-3 border border-wolf-200 dark:border-wolf-700 rounded-lg hover:bg-wolf-50 dark:hover:bg-wolf-800 transition-colors"
              >
                ...
                <span className="text-wolf-700 dark:text-wolf-300 font-medium">Google</span>
              </button>
            </div>
          </div>
